...
.sliderbox.vbottom.shade_main.center[
.font5[Gemma Dawson]]
.content.vmiddle.left[
# [`r anicon::faa("linkedin", animate="float")`   Gemma Dawson](http://linkedin.com/in/gemmadawson)
# [`r anicon::faa("envelope", animate="float")`   Gemma.Dawson@icepack.co](mailto:gemma.dawson@icepack.co)
# [`r anicon::faa("twitter", animate="float")`  @gemmadawsonza](https://twitter.com/gemmadawsonza)
# [`r anicon::faa("github", animate="float")`  @GemmaDawson](http://github.com/GemmaDawson)
]]
